...
<div id="main">
    ...
    <div class="wrapper">
        ...
        <div class="container">
            <div class="row">
                <h2 class="center-align" style="font-size: 35px">بازیابی رمز عبور</h2>
                <p class="center-align" style="font-size: 18px">برای بازیابی رمزعبور ایمیل خود را وارد نمایید تا لینک بازیابی رمز عبور به ایمیلتان ارسال گردد</p>
                <?php echo validation_errors('<p class="login-error center-align">', '</p>'); ?>
                <?php
                if($error){
                    echo '<p class="center-align login-error">'.$error.'</p>';
                }elseif($error1){
                    echo '<p class="center-align" style="color: #19cc08" >'.$error1.'</p>';
                }
                ?>
            </div>
            <div class="row">
                <div class="col s12 m12 l12">
                    <div class="row">
                        ...
                        echo form_open('Login/forgot', 'class="col s12"');
                        ?>
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col m12">
                                    <p class="center-align">
                                        <?php echo form_submit(array('class'=>'btn blue lighten-8 login-btn','value'=>'ارسال لینک بازیابی'))?>
