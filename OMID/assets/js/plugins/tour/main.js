jQuery(document).ready(function($){
	...
	function initTour() {
		...
		//close tour
		tourStepInfo.on('click', '.cd-closes', function(event){
	...
	function createNavigation(steps, n) {
		var tourNavigationHtml = '<div class="cd-nav"><span><b class="cd-actual-step">1</b>از '+n+'  </span><ul class="cd-tour-nav"><li><a href="#0" class="cd-next">جلو &#187;</a></li><li><a href="#0" class="cd-prev">&#171; عقب</a></li></ul></div><a href="#0" class="cd-closes waves-effect waves-green red darken-1 btn">اتمام</a>';
